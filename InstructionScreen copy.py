...
class InstructionScreen:
    def __init__(self, root, test_type, callback=None):
        ...
        self.title_label.pack(pady=20, anchor=tk.CENTER)
        
        # Instructions based on test type
        if test_type == "Mental Arithmetic Test":
            description_text = (
        ...
        elif test_type == "Video Feedback":
            description_text = (
                "You will be presented with a series of videos.\n"
                "After each video, you will be asked to rate your arousal level.\n"
            ...
            example_text = ""
        elif test_type == "Cold Pressor Test":
            description_text = (
        ...
        elif test_type == "Visual Stimulation Test":
            description_text = (
