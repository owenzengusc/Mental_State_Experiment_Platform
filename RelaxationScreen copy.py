...
class RelaxationScreen:
    ...
    def setup_gui(self):
        self.gap = tk.Label(self.master, text=" ", font=("Open Sans", 70), bg="white", fg="#9ba8ee")
        self.gap.pack(pady=45)

        self.label = tk.Label(self.master, text="Relaxation Time", font=("Open Sans", 110), bg="white", fg="#9ba8ee")
        self.label.pack(pady=50)

        self.directions = tk.Label(self.master, text="Please close your eyes and try to relax \n until you hear the next instruction", font=("Open Sans", 40), bg="white", fg="#3a3d42")
        self.directions.pack(pady=20)

        # Initialize countdown label with the correct starting duration
        self.countdown_label = tk.Label(self.master, text="Time Remaining: "+f"{self.duration}"+"s", font=("Open Sans", 34), bg="white", fg="#9ba8ee")
