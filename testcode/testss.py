...
FINAL_QUESTION_FREQUENCY = 10
RATE = (FINAL_QUESTION_FREQUENCY-QUESTION_FREQUENCY)/TOTAL_GAME_TIME
...
class StroopTest:
    def __init__(self, root):
        ...
        self.frequency = FINAL_QUESTION_FREQUENCY
    ...
    def question_timer(self):
        ...
        self.root.after(int(1000 / self.frequency), self.question_timer)  # Adjusted for questions per second
    ...
    def generate_question(self):
        ...
        #self.remaining_time = self.remaining_time + self.rate
        self.frequency = self.frequency + RATE
